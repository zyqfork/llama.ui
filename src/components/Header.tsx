    ...
    <header className="flex flex-col gap-2 justify-center max-md:pb-2 md:py-2 sticky top-0 z-10">
      <section className="flex flex-row items-center xl:hidden">
        ...
        <button
          ...
          onClick={() => navigate('/')}
          title={t('header.buttons.newConvBtnTitle')}
          aria-label={t('header.buttons.newConvBtnLabel')}
        >
        ...
        <section className="flex flex-row items-center">
          ...
          <div className="flex items-center">
            <button
              ...
              title={t('header.buttons.settingsBtnTitle')}
              aria-label={t('header.buttons.settingsBtnLabel')}
